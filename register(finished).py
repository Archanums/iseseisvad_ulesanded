...
def register_user():  # Funktsioon registreerimiseks
    ...
    Label(screen1, text="Registration Sucess", fg="green",
          font=("calibri", 11)).pack()  # Kui kasutaja on registreeritud, teeme teade
...
def main_screen():  # Funktsioon põhiväljale
    ...
    screen = Tk()  # Tkinteri loomine
    screen.geometry("300x250")  # Tkinteri suurus
    screen.title("Notes 1.0")  # Tkinteri nimi
    ...
    screen.mainloop()  # Tkinteri käivitamine
