...
#Impordib pildid
red_horse_img = PhotoImage(file="./Desktop/red-horse.png")
blue_horse_img = PhotoImage(file="./Desktop/blue-horse.png")

#piltide ümber tegemine
